...
OPEN_WEATHER_KEY = '32c16abdaeb5348b62b61c453f294acb'

NEWS_URL = "http://newsapi.org/v2/everything?q={0}&from=2021-02-02&sortBy=publishedAt&apiKey={1}"

NEWS_KEY = "a4d3d152fbec44b89f34427ded49c816"
...
def CovidNews(): #ดึงข่าว
    url = "http://newsapi.org/v2/everything?q=covid&from=2021-02-02&sortBy=publishedAt&apiKey=a4d3d152fbec44b89f34427ded49c816"
